...
//        driver.quit();
   ...
   public static String browerStach_accessKey ="xYfKWajUDQpJrEZV8hxX";
   ...
   public static String sauceLabs_accessKey="";
    ...
    @BeforeMethod
    public void setUp(@Optional("false") boolean useCloudEnv, @Optional("sauceLabs") String cloudEnvName, @Optional("windows") String OS, @Optional("10") String os_version, @Optional("firefox") String browserName, @Optional("86.0") String browserVersion, @Optional("https://www.google.com/") String url) throws IOException {
        // Platform: Local Machine/ Cloud Machine
        if (useCloudEnv == true){
            if (cloudEnvName.equalsIgnoreCase("browserStack")){
                getCloudDriver(cloudEnvName,browserStack_UserName,browerStach_accessKey,OS,os_version,browserName,browserVersion);
    ...
    public void dropDownByValue(String locator){
        driver.findElement(By.className(locator)).click();
